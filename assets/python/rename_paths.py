...
img_dir = "C:/Users/kbdon/OneDrive/Clay/clay-pics-2026-08-26/"
...
short_name_contents = [filename.split(".")[0] + "-1200w.jpg" for filename in plate_dir_files]

for i, filename in enumerate(plate_dir_files):
	os.rename(plate_dir + filename, plate_dir + short_name_contents[i])